...
def test_file_handler_ignore_functionality():
    ...
    assert handler.should_ignore_path(".git/config") == True
    assert handler.should_ignore_path("__pycache__/test.py") == True
    assert handler.should_ignore_path("normal_file.py") == False
